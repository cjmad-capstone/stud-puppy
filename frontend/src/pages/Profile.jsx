                    ...
                    <div className="card w-1/4 bg-base-100">
                        <div className="card-body">
                            ...
                            <div className={`flex items-center`}>
                                <figure className={`w-1/3 h-6`}><img src="https://placeimg.com/400/225/arch" alt="User pic" className={`rounded-full`} /></figure>
                                <h1 className="text-2xl pl-4">Lela</h1>
                            </div>
                            <div className={`text-sm`}>
                                <h6>lela@example.com | 555-5555</h6>
                                <h6>"I'm a passionate dog owner for over 10 years"</h6>
                            </div>
                        </div>
                    </div>
