...
/*
    public static final Logger LOG = (Logger) LoggerFactory.getLogger(FileService.class);
    private static final String[] IMAGE_EXTENSIONS = {".png", ".jpg", ".jpeg", ".gif"};
    private static final String[] VIDEO_EXTENSIONS = {".mp4", ".avi", ".mov", ".wmv"};
    private static final String[] AUDIO_EXTENSIONS = {".mp3", ".wav", ".aac", ".ogg"};
    ...
    public boolean upload(String fileName, String file) {
        return true;
    }
